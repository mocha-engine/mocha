...
public class Program
{
	...
	public static void Main( string[] args )
	{
		...
		CppStructWriter = new FileWriter( $"{args[0]}\\Host\\generated\\UnmanagedArgs.generated.h" );
		...
		using ( var cppListWriter = new FileWriter( $"{args[0]}\\Host\\generated\\InteropList.generated.h" ) )
		{
