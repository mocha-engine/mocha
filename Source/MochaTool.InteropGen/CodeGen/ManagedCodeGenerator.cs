...
internal static class ManagedCodeGenerator
{
	...
	private static void GenerateClassCode( IndentedTextWriter writer, Class sel )
	{
		//
	...
	private static void GenerateStructCode( IndentedTextWriter writer, Struct sel )
	{
	...
	private static void GenerateNamespaceCode( IndentedTextWriter writer, Class sel )
	{
		//
		// Gather everything we need into nice lists
		//
